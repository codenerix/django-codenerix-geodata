...
urlpatterns = [
    ...
    url(r'^countrys$', CountryList.as_view(), name='CDNX_geodata_countries_list'),
    url(r'^countrys/add$', CountryCreate.as_view(), name='CDNX_geodata_countries_add'),
    url(r'^countrys/addmodal$', CountryCreateModal.as_view(), name='CDNX_geodata_countries_addmodal'),
    url(r'^countrys/(?P<pk>\w+)/edit$', CountryUpdate.as_view(), name='CDNX_geodata_countries_edit'),
    url(r'^countrys/(?P<pk>\w+)/editmodal$', CountryUpdateModal.as_view(), name='CDNX_geodata_countries_editmodal'),
    ...
    url(r'^citys$', CityList.as_view(), name='CDNX_geodata_cities_list'),
    url(r'^citys/add$', CityCreate.as_view(), name='CDNX_geodata_cities_add'),
    url(r'^citys/addmodal$', CityCreateModal.as_view(), name='CDNX_geodata_cities_addmodal'),
    url(r'^citys/(?P<pk>\w+)/edit$', CityUpdate.as_view(), name='CDNX_geodata_cities_edit'),
